        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                    <h2>Liste des scans <em><?php echo $oeuvre["TITRE"] ?></em></h2>
                </div>
            </div>
        </div>
...
<div style="padding-top: 0px" id="contact" class="contact-us section">
    <div class="container">
        <div class="row">
            <div style="width: 100%" class="col-lg-6 align-self-center">
                <div  class="connexion">
                    <?php foreach(get_scan_by_id($_GET["m"]) as $scan): ?>
                        <a href="affichage_scan.php?s=<?php echo $scan["ID"].'&p=1' ?>"><p>Chapitre <?php echo $scan['NUMERO'] ?></p></a>
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
